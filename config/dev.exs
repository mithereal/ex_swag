...
config :framework, FrameworkWeb.Endpoint,
  ...
  code_reloader: true,
  debug_errors: true,
  secret_key_base: "U/+tq0rF7P3B5qdxNvgCUX/ESNvaNQzNHyxi6fRdFtv0bxxykIgyvkzavACvpsxB",
  watchers: [
...
config :framework, FrameworkWeb.Endpoint,
  live_reload: [
    ...
    patterns: [
      ...
      ~r"lib/framework_web/router\.ex$"E,
      ~r"lib/framework_web/(controllers|live|components)/.*\.(ex|heex)$"E
    ]
  ]
