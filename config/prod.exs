...
config :framework, FrameworkWeb.Endpoint, cache_static_manifest: "priv/static/cache_manifest.json"
...
# config :phoenix_kit, mailer: FrameworkWeb.Mailer
#
# Then configure your app's mailer as usual:
# config :my_app, FrameworkWeb.Mailer,
