          ...
          <%= for {_id, service} <- @rows do %>
            <tr class="hover:bg-gray-50">
              ...
              <td class="px-6 py-4 whitespace-nowrap text-sm space-x-2">
                <.link navigate={"/print-services/#{service.id}"} class="text-blue-600 hover:underline">
                  View
                </.link>
                <.link navigate={"/print-services/#{service.id}/edit"} class="text-blue-600 hover:underline">
                  Edit
                </.link>
              </td>
            </tr>
  ...
  def service_form(assigns) do
    ...
    <form phx-submit={@on_submit} class="space-y-6">
      <div class="grid grid-cols-1 gap-6 md:grid-cols-2">
        ...
        <div>
          ...
          >
            ...
            <option value="offset" selected={@service.service_type == "offset"}>Offset Printing</option>
            <option value="digital" selected={@service.service_type == "digital"}>Digital Printing</option>
            <option value="flexo" selected={@service.service_type == "flexo"}>Flexography</option>
            <option value="screen" selected={@service.service_type == "screen"}>Screen Printing</option>
            <option value="letterpress" selected={@service.service_type == "letterpress"}>Letterpress</option>
            <option value="large_format" selected={@service.service_type == "large_format"}>Large Format</option>
          </select>
        </div>
      ...
      <div class="flex gap-4">
        ...
        <.link navigate={"/print-services"} class="px-4 py-2 bg-gray-300 text-gray-700 rounded-md hover:bg-gray-400">
          Cancel
        </.link>
      </div>
    </form>
    ...
    <form class="space-y-6">
      <div class="grid grid-cols-1 gap-6 md:grid-cols-2">
        ...
        <div>
          ...
          <select name="print_service_id" class="mt-1 w-full px-3 py-2 border border-gray-300 rounded-md">
      ...
      <div class="flex gap-4">
        ...
        <.link navigate={"/print-services/orders"} class="px-4 py-2 bg-gray-300 text-gray-700 rounded-md">
          Cancel
        </.link>
      </div>
    </form>
